...
func TestDelegationResponses(t *testing.T) {
	...
	dr1 := types.NewDelegationResp(sdk.AccAddress(valAddr1).String(), valAddr2.String(), math.LegacyNewDec(5), map[string]*types.AssetWeight{}, math.ZeroInt(),
		sdk.NewCoin(sdk.DefaultBondDenom, math.NewInt(5)))
	dr2 := types.NewDelegationResp(sdk.AccAddress(valAddr1).String(), valAddr3.String(), math.LegacyNewDec(5), map[string]*types.AssetWeight{}, math.ZeroInt(),
		sdk.NewCoin(sdk.DefaultBondDenom, math.NewInt(5)))
