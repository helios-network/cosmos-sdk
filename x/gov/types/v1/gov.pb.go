...
type Proposal struct {
	...
	// current_tally_result is the current tally result of the proposal.
	CurrentTallyResult *TallyResult `protobuf:"bytes,5,opt,name=current_tally_result,json=currentTallyResult,proto3" json:"current_tally_result,omitempty"`
	...
	DepositEndTime *time.Time `protobuf:"bytes,7,opt,name=deposit_end_time,json=depositEndTime,proto3,stdtime" json:"deposit_end_time,omitempty"`
	// total_deposit is the total deposit on the proposal.
	TotalDeposit []types.Coin `protobuf:"bytes,8,rep,name=total_deposit,json=totalDeposit,proto3" json:"total_deposit"`
	...
	Expedited bool `protobuf:"varint,15,opt,name=expedited,proto3" json:"expedited,omitempty"`
	// failed_reason defines the reason why the proposal failed
	//
	// Since: cosmos-sdk 0.50
	FailedReason string `protobuf:"bytes,16,opt,name=failed_reason,json=failedReason,proto3" json:"failed_reason,omitempty"`
}
...
func (m *Proposal) GetCurrentTallyResult() *TallyResult {
	if m != nil {
		return m.CurrentTallyResult
	}
	return nil
}
...
var fileDescriptor_e05cb1c0d030febb = []byte{
	...
	,
}
...
func (m *Proposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CurrentTallyResult != nil {
		{
			size, err := m.CurrentTallyResult.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Proposal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CurrentTallyResult", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.CurrentTallyResult == nil {
				m.CurrentTallyResult = &TallyResult{}
			}
			if err := m.CurrentTallyResult.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
