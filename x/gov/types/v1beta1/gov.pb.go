...
type Proposal struct {
	...
	CurrentTallyResult TallyResult `protobuf:"bytes,5,opt,name=current_tally_result,json=currentTallyResult,proto3" json:"current_tally_result"`
	...
	DepositEndTime time.Time `protobuf:"bytes,7,opt,name=deposit_end_time,json=depositEndTime,proto3,stdtime" json:"deposit_end_time"`
	...
	VotingStartTime time.Time `protobuf:"bytes,9,opt,name=voting_start_time,json=votingStartTime,proto3,stdtime" json:"voting_start_time"`
	// voting_end_time is the end time of voting on a proposal.
	VotingEndTime time.Time `protobuf:"bytes,10,opt,name=voting_end_time,json=votingEndTime,proto3,stdtime" json:"voting_end_time"`
}
...
var fileDescriptor_6e82113c1a9a4b7c = []byte{
	...
	,
}
...
func (this *Proposal) Equal(that interface{}) bool {
	...
	if !this.CurrentTallyResult.Equal(&that1.CurrentTallyResult) {
		return false
	}
