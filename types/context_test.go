...
func (s *contextTestSuite) TestContextWithCustom() {
	...
	ctx = types.NewContext(nil, map[string]storetypes.MultiStore{}, header, ischeck, logger)
...
func (s *contextTestSuite) TestContextHeader() {
	...
	ctx = types.NewContext(nil, map[string]storetypes.MultiStore{}, cmtproto.Header{}, false, nil)
...
func (s *contextTestSuite) TestContextHeaderClone() {
	...
	for name, tc := range cases {
		...
		s.T().Run(name, func(t *testing.T) {
			ctx := types.NewContext(nil, map[string]storetypes.MultiStore{}, tc.h, false, nil)
...
func (s *contextTestSuite) TestUnwrapSDKContext() {
	sdkCtx := types.NewContext(nil, map[string]storetypes.MultiStore{}, cmtproto.Header{}, false, nil)
